  ...
  var r = (function() {
        ...
        r(t, [
          {
            ...
            value: function(t, n) {
              ...
              this.list.push({ fn: t, data: n, one: e }), this.length++;
            }
          },
          {
            key: "remove",
            value: function(t) {
              for (var n = 0; n < this.list.length; n++)
                this.list[n].fn === t &&
                  (this.list.splice(n, 1), this.length--, n--);
            }
          },
          {
            key: "empty",
          ...
          },
          {
            ...
            value: function(t, n) {
              ...
              a.isFunction(e)
                ? e.call(this, t, i, n)
                : a.isFunction(i.fn) && i.fn.call(t || window, i.data),
        ...
        r(t, [
          {
            key: "initialize",
            value: function() {
              (this.callbacks = { enter: new u(), leave: new u() }),
            ...
            value: function(t, n, e) {
              ...
              return (
                "undefined" == typeof e &&
                  ...
                  ((e = n), (n = void 0)),
                a.isFunction(e)
                  ? ("undefined" != typeof this.callbacks[t] &&
          ...
          },
          {
            ...
            value: function(t, n) {
              ...
              return (
                "undefined" == typeof t
                  ? (this.callbacks.enter.empty(), this.callbacks.leave.empty())
                  : t in this.callbacks &&
                    (n
    ...
    l = {
      ...
      between: function(t, n) {
        var e =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "px";
    ...
    h = (function(t) {
      function o(t) {
        ...
        var a = l.get(e, r, s),
          u = n(
            this,
            (o.__proto__ || Object.getPrototypeOf(o)).call(this, t, a)
          );
    ...
    d = (function(t) {
      function r(t) {
        ...
        return (
          ...
          n(
            this,
            (r.__proto__ || Object.getPrototypeOf(r)).call(this, t, o.join(","))
          )
        );
      }
      return e(r, t), r;
  ...
  (m.defaults = s),
    (m = a.extend(m, {
      ...
      on: function(t, n, e, i) {
        ...
        if (((t = t.trim()), "change" === t))
          return (i = e), (e = n), f.on(e, i, r);
        if (t.includes(" ")) {
